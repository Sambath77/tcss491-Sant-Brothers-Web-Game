class Mario {
  ...
  loadAnimations() {
    ...
    this.animations[2][1][0] = new Animator(
      this.spritesheet,
      239,
      52,
      16,
    ...
    this.animations[2][2][0] = new Animator(
      this.spritesheet,
      237,
      122,
      16,
    ...
    this.animations[2][1][1] = new Animator(
      this.spritesheet,
      90,
      52,
      16,
    ...
    this.animations[2][2][1] = new Animator(
      this.spritesheet,
      102,
      122,
      16,
    ...
    // slide animation
    // facing right
    this.animations[3][0][0] = new Animator(
      this.spritesheet,
      59,
      0,
      16,
    ...
    this.animations[3][1][0] = new Animator(
      this.spritesheet,
      329,
      52,
      16,
    ...
    this.animations[3][2][0] = new Animator(
      this.spritesheet,
      337,
      122,
      16,
    ...
    // facing left
    this.animations[3][0][1] = new Animator(
      this.spritesheet,
      330,
      0,
      16,
    ...
    this.animations[3][1][1] = new Animator(
      this.spritesheet,
      60,
      52,
      16,
    ...
    this.animations[3][2][1] = new Animator(
      this.spritesheet,
      52,
      122,
      16,
    ...
    // jump animation
    // facing right
    this.animations[4][0][0] = new Animator(
      this.spritesheet,
      359,
      0,
      16,
    ...
    this.animations[4][1][0] = new Animator(
      this.spritesheet,
      359,
      52,
      16,
    ...
    this.animations[4][2][0] = new Animator(
      this.spritesheet,
      362,
      122,
      16,
    ...
    // facing left
    this.animations[4][0][1] = new Animator(
      this.spritesheet,
      29,
      0,
      16,
    ...
    this.animations[4][1][1] = new Animator(
      this.spritesheet,
      30,
      52,
      16,
    ...
    this.animations[4][2][1] = new Animator(
      this.spritesheet,
      27,
      122,
      16,
    ...
    this.animations[5][1][0] = new Animator(
      this.spritesheet,
      389,
      47,
      16,
    ...
    this.animations[5][2][0] = new Animator(
      this.spritesheet,
      389,
      117,
      16,
    ...
    this.animations[5][1][1] = new Animator(
      this.spritesheet,
      0,
      48,
      16,
    ...
    this.animations[5][2][1] = new Animator(
      this.spritesheet,
      0,
      118,
      16,
      ...
      this.game.entities.forEach(function (entity) {
        if (entity.BB && that.BB.collide(entity.BB)) {
          if (that.velocity.y > 0) {
            // falling
            if (
              (entity instanceof Nground ||
                entity instanceof Brick ||
                entity instanceof Block ||
                entity instanceof Tube ||
                entity instanceof SideTube) && // landing
            ...
            if (
              (entity instanceof Skeleton || entity instanceof Zombie) && // squish skeleton
          ...
          if (
            ...
            if (that.BB.collide(entity.leftBB)) {
              ...
              if (entity instanceof SideTube && that.game.right)
                that.game.camera.loadLevelOne(
                  162.5 * PARAMS.BLOCKWIDTH,
