class SceneManager {
  ...
  loadLevelOne(x, y) {
    ...
    background = new BigHill(this.game, 0, 11.5 * PARAMS.BLOCKWIDTH);
    this.game.addEntity(background);
    background = new Bush(
      this.game,
    ...
    background = new Hill(
      ...
      12.75 * PARAMS.BLOCKWIDTH
    );
    this.game.addEntity(background);
    background = new Bush(
      this.game,
      23.5 * PARAMS.BLOCKWIDTH,
      13 * PARAMS.BLOCKWIDTH,
      5
    );
    this.game.addEntity(background);
    ...
    background = new Bush(
      this.game,
      41.5 * PARAMS.BLOCKWIDTH,
      13 * PARAMS.BLOCKWIDTH,
      2
    );
    this.game.addEntity(background);
    background = new BigHill(
      this.game,
      48 * PARAMS.BLOCKWIDTH,
      11.5 * PARAMS.BLOCKWIDTH
    );
    this.game.addEntity(background);
    background = new Cloud(
      this.game,
      56.5 * PARAMS.BLOCKWIDTH,
      4 * PARAMS.BLOCKWIDTH,
      1
    );
    this.game.addEntity(background);
    ...
    background = new BigHill(
      this.game,
      95 * PARAMS.BLOCKWIDTH,
      11.5 * PARAMS.BLOCKWIDTH
    );
    this.game.addEntity(background);
    background = new Cloud(
      this.game,
      103.5 * PARAMS.BLOCKWIDTH,
      4 * PARAMS.BLOCKWIDTH,
      1
    );
    this.game.addEntity(background);
    ...
    background = new BigHill(
      this.game,
      143 * PARAMS.BLOCKWIDTH,
      11.5 * PARAMS.BLOCKWIDTH
    );
    this.game.addEntity(background);
    background = new Cloud(
      this.game,
      151.5 * PARAMS.BLOCKWIDTH,
      4 * PARAMS.BLOCKWIDTH,
      1
    );
    this.game.addEntity(background);
